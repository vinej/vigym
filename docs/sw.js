"use strict";
var precacheConfig = [
	["assets/favicon.ico", "53ac170e970ad034a55ee15ce198708c"],
	[
	  "assets/icons/android-chrome-192x192.png",
	  "59e221032ab061cad83b6ce2bcddbde8"
	],
	[
	  "assets/icons/android-chrome-512x512.png",
	  "cf3fdf7af60a294d6d3f48cb7ad82488"
	],
	["vigym/assets/icons/apple-touch-icon.png", "a0e46feb3cc577478b127936e739dd08"],
	["vigym/assets/icons/favicon-16x16.png", "d712b605ed58419c7e6d4ab885d147b7"],
	["vigym/assets/icons/favicon-32x32.png", "2f7ce797cf8f198dedb9a9f38b7ef13b"],
	["vigym/assets/icons/mstile-150x150.png", "ba817517b2c4e1ba1ce802c4d4fafdb4"],
	["vigym/bundle.2a5ee.js", "10ed9c857975ccccf30c97ddad568dea"],
	["vigym/index.html", "d8685359baf414485dfe58c71de38189"],
	["vigym/polyfills.b6dfc.js", "6665dce8442cb91010cd7c6016f1af24"],
	["vigym/route-home.chunk.0817f.js", "6488cdbf113b5f2039adba370907ecc1"],
	["vigym/route-profile.chunk.1e466.js", "94fcdbbadd9cde45e336021071655b28"],
	["vigym/ssr-build/ssr-bundle.js", "c04c778c1c2ac89318ec2e34e8290c9b"],
	["vigym/ssr-build/style.1411a.css", "39368e804f02ae435cfd46fb0b1d1988"],
	["vigym/style.1411a.css", "39368e804f02ae435cfd46fb0b1d1988"]
  ],
  cacheName =
...
self.addEventListener("install", function(e) {
  ...
  (function(e) {
	...
	return (function e(t, n, r) {
	  ...
	  for (
		var c = "function" == typeof require && require, a = 0;
		a < r.length;
		a++
	  )
		o(r[a]);
			...
			function c(e, t, n) {
			  ...
			  return (
				...
				u
				  ...
				  .then(function(e) {
					return u.expireEntries(e, a, c, i);
				  })
				  .then(function(e) {
			...
			t.exports = {
			  ...
			  setTimestampForUrl: function(e, t, n) {
				return new Promise(function(r, o) {
				  var a = e.transaction(c, "readwrite");
				  a.objectStore(c).put({ url: t, timestamp: n }),
				...
				o.debug("install event fired"),
				  ...
				  e.waitUntil(
					o.openCache({ cache: { name: t } }).then(function(e) {
					  return Promise.all(a.preCacheItems)
						.then(r)
		...
		6: [
		  function(e, t, n) {
			...
			["get", "post", "put", "delete", "head", "any"].forEach(function(
			  ...
			  (a.prototype.add = function(e, t, n, c) {
				var a;
				(c = c || {}),
				  t instanceof RegExp
					? (a = RegExp)
					: (a =
						(a = c.origin || self.location.origin) instanceof RegExp
						  ? a.source
						  : (function(e) {
							  return e.replace(
								/[-\/\\^$*+?.()|[\]{}]/g,
			  ...
			  return (
				...
				o.openCache(n).then(function(t) {
				  return t.match(e).then(function(t) {
					var c = n.cache || r.cache,
					  a = Date.now();
					return o.isResponseFresh(t, c.maxAgeSeconds, a)
					  ? t
					  : o.fetchAndCache(e, n);
				  });
				})
				...
				o.openCache(n).then(function(t) {
				  return t.match(e).then(function(e) {
					var t = n.cache || r.cache,
					  c = Date.now();
					if (o.isResponseFresh(e, t.maxAgeSeconds, c)) return e;
				  });
				})
			  );
			};
			  ...
			  return (
				...
				new Promise(function(c, a) {
				  var s = !1,
					...
					f = function(e) {
					  e instanceof Response ? c(e) : u("No result returned");
					};
		...
		11: [
		  function(e, t, n) {
			var r = e("../options"),
			  o = e("../helpers");
			t.exports = function(e, t, n) {
			  var c = (n = n || {}).successResponses || r.successResponses,
			  ...
			  return (
				...
				o.openCache(n).then(function(t) {
				  ...
				  var h = o
					.fetchAndCache(e, n)
					.then(function(e) {
					  if ((s && clearTimeout(s), c.test(e.status))) return e;
					  throw (o.debug(
		...
		13: [
		  function(e, t, n) {
			var r = e("./options"),
			  ...
			  a = e("./strategies"),
			  s = e("./listeners");
			c.debug("Service Worker Toolbox is loading"),
		...
		15: [
		  function(e, t, n) {
			function r(e, t) {
			  for (
				...
				var f = n[0],
				  h = n[1],
				  l = n.index;
				if (((a += e.slice(c, l)), (c = l + f.length), h)) a += h[1];
				else {
				  var p = e[c],
					m = n[2],
					g = n[3],
			  ...
			  return c < e.length && (a += e.substr(c)), a && r.push(a), r;
			}
			function o(e) {
			...
			function a(e) {
			  ...
			  return function(n, r) {
				for (
				  var a = "",
					s = n || {},
					i = (r || {}).pretty ? o : encodeURIComponent,
					u = 0;
				  u < e.length;
				  u++
				) {
				  ...
				  if ("string" != typeof f) {
					...
					if (p(l)) {
					  ...
					  for (var d = 0; d < l.length; d++) {
						...
						a += (0 === d ? f.prefix : f.delimiter) + h;
					  }
					} else {
					  if (((h = f.asterisk ? c(l) : i(l)), !t[u].test(h)))
						throw new TypeError(
						  'Expected "' +
							f.name +
							'" to match "' +
			...
			function h(e, t, n) {
			  p(t) || ((n = t || n), (t = []));
			  for (
				var r = (n = n || {}).strict, o = !1 !== n.end, c = "", a = 0;
				a < e.length;
				a++
			  ) {
				var i = e[a];
				if ("string" == typeof i) c += s(i);
				else {
				  var h = s(i.prefix),
					l = "(?:" + i.pattern + ")";
				  t.push(i),
			  ...
			  var d = s(n.delimiter || "/"),
				m = c.slice(-d.length) === d;
			  return (
				r ||
				  (c = (m ? c.slice(0, -d.length) : c) + "(?:" + d + "(?=$))?"),
				(c += o ? "$" : r && m ? "" : "(?=" + d + "|$)"),
				u(new RegExp("^" + c, f(n)), t)
			  );
			}
			function l(e, t, n) {
			  return (
