...
var precacheConfig = [
        ...
        [
            "assets/icons/android-chrome-192x192.png", "59e221032ab061cad83b6ce2bcddbde8"
        ],
        [
            "assets/icons/android-chrome-512x512.png", "cf3fdf7af60a294d6d3f48cb7ad82488"
        ],
        [
            "assets/icons/apple-touch-icon.png", "a0e46feb3cc577478b127936e739dd08"
        ],
        [
        ...
        [
            "bundle.a4e57.js", "664edede8ecac2fa2261b89299b705c3"
        ],
        [
            "favicon.ico", "53ac170e970ad034a55ee15ce198708c"
        ],
        [
            "index.html", "e65b9310502af9d07808f099e2bccd42"
        ],
        [
            "manifest.json", "a993e37f87d743e21fb965d2d6c95858"
        ],
        [   "style.44b27.css", "c06ab231f59d6acf394d33ca9ba1fcfa"]
    ],
...
self.addEventListener("fetch", function (e) {
    if ("GET" === e.request.method) {
        var n,
            t = stripIgnoredUrlParameters(e.request.url, ignoreUrlParametersMatching);
        (n = urlsToCacheKeys.has(t)) || (t = addDirectoryIndex(t, "index.html"), n = urlsToCacheKeys.has(t));
        !n && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (t = new URL("index.html", self.location).toString(), n = urlsToCacheKeys.has(t)),
        n && e.respondWith(caches.open(cacheName).then(function (e) {
            return e
                .match(urlsToCacheKeys.get(t))
                .then(function (e) {
                    if (e) 
                        return e;
